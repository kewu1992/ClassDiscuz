...
import cmu.banana.classdiscuz.ws.local.ApplicationSessionStateCallback;
...
public class ChatBaseActivity extends AppCompatActivity implements ApplicationSessionStateCallback {
    ...
    private void recreateSession(final QBUser user){
        ...
        ChatService.getInstance().login(user, new QBEntityCallbackImpl() {
            ...
            public void onSuccess() {
                ...
                sessionActive = true;
                ChatBaseActivity.this.onFinishSessionRecreation(true);
            }
            ...
            public void onError(List errors) {
                ...
                ChatBaseActivity.this.onFinishSessionRecreation(false);
            }
        });
    }
    ...
    private void showProgressDialog(){
        if(progressDialog == null) {
            progressDialog = new ProgressDialog(ChatBaseActivity.this);
